...
/**
 * The GenericParallel is meant to be the most versatile template and therefore suited only
 * for simi-advanced users.
 * 
 * Most of the magic of this interface resting the the DataComm Class which has to be 
 * inherited by the user's data objects
 * 
 * Note:As of April 2009, the Generic Template has not being update to use MultiModePipes.
 * 
 * @author jfvillal
 *
 */
...
public abstract class GenericParallel extends BasicLayerInterface {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2073111944601329343L;
	/**
